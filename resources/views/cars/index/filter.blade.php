<form action="{{ url()->current() }}">
    ...
    <div class="mb-3">
        <label for="car_serie" class="form-label">Car Serie</label>
    ...
    <div class="form-check mb-3">
        <input class="form-check-input" type="checkbox" value="1" id="inService" name="inService" {{ $f_inService ? 'checked':'' }}>
